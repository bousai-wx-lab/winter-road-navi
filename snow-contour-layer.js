import { CONTOUR_COLORS, SNOW_THRESHOLDS } from "./snow-display-data.js?v=20260924-snow2";
...
export function createSnowContourLayer() {
  ...
  return {
    ...
    setPositiveOnly(value) {
      if (typeof value !== "boolean") throw new Error("積雪の0cm除外設定が不正です");
      positiveOnly = value;
      map?.triggerRepaint();
    },
    onAdd(nextMap, gl) {
